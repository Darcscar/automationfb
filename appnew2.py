    ...
    msg = {
        "attachment": {
            ...
            "payload": {
                ...
                "buttons": [
                    {"type": "web_url", "url": FOODPANDA_URL, "title": "Open Foodpanda", "webview_height_ratio": "full"}
                ]
            }
        }
    }
    ...
    msg = {
        "attachment": {
            ...
            "payload": {
                ...
                "buttons": [
                    {"type": "web_url", "url": GOOGLE_MAP_URL, "title": "Open Location", "webview_height_ratio": "full"}
                ]
            }
        }
    }
...
def handle_payload(psid, payload):
    ...
    # If store closed, still allow menu/location/Foodpanda
    if not is_store_open():
        closed_msg = store_closed_message()
        call_send_api(psid, {"text": closed_msg})
