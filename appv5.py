...
GOOGLE_MAP_URL = "https://maps.app.goo.gl/GQUDgxLqgW6no26X8"  # Your Google Maps link
...
def handle_payload(psid, payload):
    if not payload or payload == "GET_STARTED":
        # Greeting + welcome only once
        return send_quick_replies(psid, show_greeting=True)

    # Always allow menu/location/contact even if store closed
